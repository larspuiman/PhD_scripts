...
//    double conc_act[num_compounds];               /* Actual intracellular conc */
    ...
    double int_time = 48*3600.0/3600;                                              /* timestep in [h] */
    ...
    for (double c_CO = 0.29; c_CO <= 0.30; c_CO += 0.025) 
    {

        /* set Concentrations */
        double conc_const[3];
        conc_const[0] = c_CO;		
        conc_const[1] = 0.846 * c_CO + 0.0885; 
        conc_const[2] = 24.5735; 
        ...
        sprintf(Filename_conc, "Results_cx100mM_long/conc_data_cCO_%.2g_72h.dat", (double) c_CO);
        sprintf(Filename_dcdt, "Results_cx100mM_long/dcdt_data_cCO_%.2g_72h.dat", (double) c_CO);
        sprintf(Filename_time, "Results_cx100mM_long/t_data_cCO_%.2g_72h.dat", (double) c_CO);

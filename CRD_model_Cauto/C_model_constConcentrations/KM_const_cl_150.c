...
//    double conc_act[num_compounds];               /* Actual intracellular conc */
    ...
    double int_time = 5.0*3600/3600;                                              /* timestep in [h] */
    ...
    for (double c_CO = 0.045; c_CO <= 0.05; c_CO += 0.01) 
    {

        /* set Concentrations */
        double conc_const[3];
        conc_const[0] = c_CO;		
        conc_const[1] = 1.43 * c_CO + 0.110;                             /* linaear fit from cftool from the dataset at 500 s. R2 = 0.8416*/ 
        conc_const[2] = 17.5929; 
        ...
        sprintf(Filename_conc, "Results_cx150mM_long/conc_data_cCO_%.2g.dat", (double) c_CO);
        sprintf(Filename_dcdt, "Results_cx150mM_long/dcdt_data_cCO_%.2g.dat", (double) c_CO);
        sprintf(Filename_time, "Results_cx150mM_long/t_data_cCO_%.2g.dat", (double) c_CO);

...
//    double conc_act[num_compounds];               /* Actual intracellular conc */
    ...
    for (double freq = 1.5; freq <= 3; freq += 1.5) 
    {
        ...
        sprintf(Filename_conc, "Results_C_script/conc_data_freq_%g_s.dat", (double) freq);
        sprintf(Filename_dcdt, "Results_C_script/dcdt_data_freq_%g_s.dat", (double) freq);
        sprintf(Filename_time, "Results_C_script/t_data_freq_%g_s.dat", (double) freq);
